...
[![Figure 1](../results/horse_pops_plot.png)]
...
[![Figure 2](../results/horse_pops_plot_largest_sd.png){width=70%}]
...
In Figure 2 we zoom in and look at the province of `{python} largest`, which had the largest spread of values in terms of standard deviation.
